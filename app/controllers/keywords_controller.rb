class KeywordsController < ApplicationController
  ...
  def batch_keywording
    for article in Article.all
      ...
      if article.content.include?("حساب") || article.content.include?("account") ||  article.content.include?("اکانت") || article.content.include?("پسورد") || article.content.include?("کد امنیتی")
