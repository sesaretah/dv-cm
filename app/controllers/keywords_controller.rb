class KeywordsController < ApplicationController
  ...
  def batch_keywording
    for article in Article.all
      ...
      if (!article.content.include?("عالی") || !article.content.include?("Best") || !article.content.include?("خوب")) && (article.content.include?("افتضاح") || article.content.include?("آشغال") || article.content.include?("ضعیف") || article.content.include?("گدا") || article.content.include?("دزد") || article.content.include?("ریدید") || article.content.include?("اشغال") || article.content.include?("خجالت") || article.content.include?("داغون") || article.content.include?("تباه") || article.content.include?("مزخرف") || article.content.include?("ناکارآمد") || article.content.include?("بسیار بد") ||  article.content.include?("ریدم به") || article.content.include?("لعنت") || article.content.include?("کیری") || article.content.include?("به درد نخوره") || article.content.include?("قابل قبولی نیست") || article.content.include?("قابل قبول نیست")  || article.content.include?("قابل قبول نیست") || article.content.include?("متاسفم") || article.content.include?("بدرد نخوره") || article.content.include?("رو اعصابه") || article.content.include?("رو اعصابمه"))
